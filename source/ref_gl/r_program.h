...
#define GLSL_SHADER_MATERIAL_CELLSHADING		GLSL_BIT(44)
...
#define GLSL_SHADER_SHADOWMAP_RGB_SHADOW		GLSL_BIT(37)

// outlines
#define GLSL_SHADER_OUTLINE_OUTLINES_CUTOFF		GLSL_BIT(32)

// cellshading program features
#define GLSL_SHADER_CELLSHADE_DIFFUSE			GLSL_BIT(32)
#define GLSL_SHADER_CELLSHADE_DECAL				GLSL_BIT(33)
#define GLSL_SHADER_CELLSHADE_DECAL_ADD			GLSL_BIT(34)
#define GLSL_SHADER_CELLSHADE_ENTITY_DECAL		GLSL_BIT(35)
#define GLSL_SHADER_CELLSHADE_ENTITY_DECAL_ADD	GLSL_BIT(36)
#define GLSL_SHADER_CELLSHADE_STRIPES			GLSL_BIT(37)
#define GLSL_SHADER_CELLSHADE_STRIPES_ADD		GLSL_BIT(38)
#define GLSL_SHADER_CELLSHADE_CELL_LIGHT		GLSL_BIT(39)
#define GLSL_SHADER_CELLSHADE_CELL_LIGHT_ADD	GLSL_BIT(40)
