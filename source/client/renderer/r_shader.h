...
enum {
	...
	SHADER_LIGHTMAP                 = 1 << 7,
	SHADER_NO_TEX_FILTERING         = 1 << 8,
	SHADER_ALLDETAIL                = 1 << 9,
	SHADER_NODRAWFLAT               = 1 << 10,
	SHADER_SOFT_PARTICLE            = 1 << 11,
	SHADER_FORCE_OUTLINE_WORLD      = 1 << 12,
	SHADER_STENCILTEST              = 1 << 13,
};
...
enum {
	...
	SHADERPASS_GREYSCALE            = SHADERPASS_MARK_BEGIN << 2,
	SHADERPASS_SKYBOXSIDE           = SHADERPASS_MARK_BEGIN << 3,

	SHADERPASS_AFUNC_GT0            = SHADERPASS_MARK_BEGIN << 4,
	SHADERPASS_AFUNC_LT128          = SHADERPASS_MARK_BEGIN << 5,
	SHADERPASS_AFUNC_GE128          = SHADERPASS_AFUNC_GT0 | SHADERPASS_AFUNC_LT128,
	SHADERPASS_NOSRGB               = SHADERPASS_MARK_BEGIN << 6,
};
