...
#define GLSL_SHADER_COMMON_DLIGHTS              GLSL_BIT( 9 )
#define GLSL_SHADER_COMMON_DLIGHT_CUBEFILTER    GLSL_BIT( 10 )
#define GLSL_SHADER_COMMON_DLIGHT_DIRECTIONAL   GLSL_BIT( 11 )
...
#define GLSL_SHADER_Q3_LIGHTSTYLE0              GLSL_BIT( 37 )
#define GLSL_SHADER_Q3_LIGHTSTYLE1              GLSL_BIT( 38 )
#define GLSL_SHADER_Q3_LIGHTSTYLE2              ( GLSL_SHADER_Q3_LIGHTSTYLE0 | GLSL_SHADER_Q3_LIGHTSTYLE1 )
#define GLSL_SHADER_Q3_LIGHTSTYLE3              GLSL_BIT( 39 )
...
#define GLSL_SHADER_Q3_LIGHTMAP_BICUBIC         GLSL_BIT( 42 )
