...
#define GLSL_SHADER_COMMON_RGB_GEN_VERTEX       GLSL_BIT( 3 )
#define GLSL_SHADER_COMMON_RGB_GEN_ONE_MINUS_VERTEX GLSL_BIT( 4 )
#define GLSL_SHADER_COMMON_RGB_DISTANCERAMP     ( GLSL_SHADER_COMMON_RGB_GEN_VERTEX |\
													GLSL_SHADER_COMMON_RGB_GEN_ONE_MINUS_VERTEX )

#define GLSL_SHADER_COMMON_SRGB2LINEAR          GLSL_BIT( 5 )

#define GLSL_SHADER_COMMON_ALPHA_GEN_VERTEX     GLSL_BIT( 6 )
#define GLSL_SHADER_COMMON_ALPHA_GEN_ONE_MINUS_VERTEX GLSL_BIT( 7 )
...
#define GLSL_SHADER_COMMON_BONE_TRANSFORMS1     GLSL_BIT( 8 )
#define GLSL_SHADER_COMMON_BONE_TRANSFORMS2     GLSL_BIT( 9 )
#define GLSL_SHADER_COMMON_BONE_TRANSFORMS3     ( GLSL_SHADER_COMMON_BONE_TRANSFORMS1 | GLSL_SHADER_COMMON_BONE_TRANSFORMS2 )
#define GLSL_SHADER_COMMON_BONE_TRANSFORMS4     GLSL_BIT( 10 )
...
#define GLSL_SHADER_COMMON_DLIGHT_DIRECTIONAL   GLSL_BIT( 13 )
...
#define GLSL_SHADER_COMMON_LIGHTING             GLSL_BIT( 17 )
...
#define GLSL_SHADER_COMMON_REALTIME_SHADOWS     GLSL_BIT( 25 )
#define GLSL_SHADER_COMMON_SHADOWMAP_SAMPLERS   GLSL_BIT( 26 )
...
#define GLSL_SHADER_MATERIAL_ENTITY_DECAL       GLSL_BIT( 46 )
#define GLSL_SHADER_MATERIAL_ENTITY_DECAL_ADD   GLSL_BIT( 47 )
#define GLSL_SHADER_MATERIAL_LIGHTMAP_ARRAYS    GLSL_BIT( 48 )
#define GLSL_SHADER_MATERIAL_LIGHTMAP_BICUBIC   GLSL_BIT( 49 )
...
#define GLSL_SHADER_Q3_LIGHTMAP_BICUBIC   GLSL_BIT( 43 )
