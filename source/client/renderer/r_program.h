...
#define GLSL_SHADER_COMMON_AUTOSPRITE           GLSL_BIT( 10 )
#define GLSL_SHADER_COMMON_AUTOSPRITE2          GLSL_BIT( 11 )

#define GLSL_SHADER_COMMON_INSTANCED_TRANSFORMS GLSL_BIT( 12 )
#define GLSL_SHADER_COMMON_INSTANCED_ATTRIB_TRANSFORMS  GLSL_BIT( 13 )

#define GLSL_SHADER_COMMON_SOFT_PARTICLE        GLSL_BIT( 14 )

#define GLSL_SHADER_COMMON_AFUNC_GT0            GLSL_BIT( 15 )
#define GLSL_SHADER_COMMON_AFUNC_LT128          GLSL_BIT( 16 )
#define GLSL_SHADER_COMMON_AFUNC_GE128          ( GLSL_SHADER_COMMON_AFUNC_GT0 | GLSL_SHADER_COMMON_AFUNC_LT128 )

#define GLSL_SHADER_COMMON_FRAGMENT_HIGHP       GLSL_BIT( 17 )

#define GLSL_SHADER_COMMON_LINEAR2SRB           GLSL_BIT( 18 )
...
#define GLSL_SHADER_MATERIAL_AMBIENT_COMPENSATION GLSL_BIT( 34 )
#define GLSL_SHADER_MATERIAL_DECAL              GLSL_BIT( 35 )
#define GLSL_SHADER_MATERIAL_DECAL_ADD          GLSL_BIT( 36 )
#define GLSL_SHADER_MATERIAL_BASETEX_ALPHA_ONLY GLSL_BIT( 37 )
#define GLSL_SHADER_MATERIAL_HALFLAMBERT        GLSL_BIT( 38 )
#define GLSL_SHADER_MATERIAL_ENTITY_DECAL       GLSL_BIT( 39 )
#define GLSL_SHADER_MATERIAL_ENTITY_DECAL_ADD   GLSL_BIT( 40 )
