...
* FTLIB_StringWidth
*/
size_t FTLIB_StringWidth( const char *str, struct qfontface_s *font, size_t maxlen, textdrawflag_t flags )
{
...
*/
size_t FTLIB_StrlenForWidth( const char *str, struct qfontface_s *font, size_t maxwidth, textdrawflag_t flags )
{
...
*/
void FTLIB_DrawClampString( int x, int y, const char *str, int xmin, int ymin, int xmax, int ymax, struct qfontface_s *font, vec4_t color, textdrawflag_t flags )
{
	if( ftlib_export ) {
...
* FTLIB_DrawRawString
*/
size_t FTLIB_DrawRawString( int x, int y, const char *str, size_t maxwidth, struct qfontface_s *font, vec4_t color, textdrawflag_t flags )
{
