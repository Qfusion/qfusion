...
// wsw: rename from solid_t to aas_solid_t, add AAS prefix to enum values
typedef enum
{
	AAS_SOLID_NOT,			// no interaction with other objects
	AAS_SOLID_TRIGGER,		// only touch when inside, after moving
	AAS_SOLID_BBOX,			// touch on edge
	AAS_SOLID_BSP			// bsp clip, touch on edge
} aas_solid_t;
