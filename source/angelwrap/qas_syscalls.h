...
static inline void trap_Diag_Begin( const char **filenames ) {
	ANGELWRAP_IMPORT.Diag_Begin( filenames );
}
...
static inline void trap_Diag_End( void ) {
	ANGELWRAP_IMPORT.Diag_End();
}
