...
// different type.
void CScriptDictionary::Set(const asstring_t &key, asINT64 &value)
{
...
bool CScriptDictionary::Get(const asstring_t &key, asINT64 &value) const
{
...
static void RegisterScriptDictionary_Native(asIScriptEngine *engine)
{
	...
	r = engine->RegisterObjectMethod("Dictionary", "void set(const String &in, int64&in)", asMETHODPR(CScriptDictionary,Set,(const asstring_t&,asINT64&),void), asCALL_THISCALL); assert( r >= 0 );
